...
import slidelistview.wrap.FrontViewWrapLayout;
import slidelistview.wrap.SlideItemWrapLayout;
...
//			}
//		});
		animate(mSlideItem.frontView).translationX(moveTo).setDuration(getAnimationTime()).setListener(new com.nineoldandroids.animation.AnimatorListenerAdapter() {
			@Override
